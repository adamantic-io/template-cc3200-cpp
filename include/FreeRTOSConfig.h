...
#define configTOTAL_HEAP_SIZE			( ( size_t ) (32768) ) //( ( size_t ) ( 5000) )
...
#define configMAX_SYSCALL_INTERRUPT_PRIORITY 	( 1 << 5 )  /* Priority 1, or 32 as only the top three bits are implemented. */
...
/* It seems that in this port of FreeRTOS we don't have a pdMS_TO_TICKS macro defined
   so we are defining it here "if it doesn't exist"
*/
